...
import { Shield, User, Edit3, Save, X, AlertCircle, CheckCircle, Search, FileText, MessageSquare, Check, Trash2, Clock, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-stone-600 dark:text-zinc-400">
              Manage users, roles, and moderate community content.
            </p>
          </div>
        </div>
